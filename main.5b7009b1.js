/*! For license information please see main.5b7009b1.js.LICENSE.txt */
(() => {
	"use strict";
	var e = {
			4: (e, t, n) => {
				...
				var $ = I(null),
					...
					q = I(null);
				function W(e, t) {
					switch ((H(V, t), H(B, e), H($, null), t.nodeType)) {
						case 9:
						case 11:
							e =
				...
				function G(e) {
					B.current === e && (U($), U(B)),
						q.current === e && (U(q), (Gf._currentValue = A));
				}
				...
				var Te = Math.random().toString(36).slice(2),
					Oe = "__reactFiber$" + Te,
					je = "__reactProps$" + Te,
					De = "__reactContainer$" + Te,
					Re = "__reactEvents$" + Te,
					Ae = "__reactListeners$" + Te,
				...
				function Bn() {
					Dn &&
						(Dn.detachEvent("onpropertychange", Vn),
						(Rn = Dn = null));
				}
				function Vn(e) {
					if ("value" === e.propertyName && Mn(Rn)) {
						var t = [];
						jn(t, Rn, e, Tt(e)), At(An, t);
					}
				}
				function qn(e, t, n) {
					"focusin" === e
						? (Bn(),
						  (Rn = n),
						  (Dn = t).attachEvent("onpropertychange", Vn))
						: "focusout" === e && Bn();
				}
				function Wn(e) {
					if (
				...
				function Yn(e, t) {
					...
					for (r = 0; r < n.length; r++) {
						var l = n[r];
						if (!Y.call(t, l) || !Gn(e[l], t[l])) return !1;
					}
					return !0;
				}
				function Xn(e) {
				...
				function jr(e) {
					if (50 < Os) throw ((Os = 0), (js = null), Error(o(185)));
				...
				function Fr(e, t) {
					...
					return (
						null === n
							? (((n = Ar(e.tag, t, e.key, e.mode)).elementType =
									e.elementType),
							  (n.type = e.type),
				...
				function Ur(e, t, n, r, l, a) {
					...
					if (((r = e), "function" === typeof e)) Mr(e) && (i = 1);
						...
						e: switch (e) {
							...
							case y:
								return (
									((e = Ar(12, n, t, 2 | l)).elementType = y),
									(e.lanes = a),
									e
								);
							case x:
								return (
									((e = Ar(13, n, t, l)).elementType = x),
									(e.lanes = a),
									e
								);
							case E:
								return (
									((e = Ar(19, n, t, l)).elementType = E),
									(e.lanes = a),
									e
								);
							default:
				...
				var Vr = [],
					...
					Zr = "";
				function Jr(e, t) {
					(Vr[qr++] = Qr), (Vr[qr++] = Wr), (Wr = e), (Qr = t);
				}
				function el(e, t, n) {
					(Kr[Gr++] = Xr), (Kr[Gr++] = Zr), (Kr[Gr++] = Yr), (Yr = e);
					var r = Xr;
					e = Zr;
					var l = 32 - pe(r) - 1;
					(r &= ~(1 << l)), (n += 1);
				...
				var rl = null,
					...
					ul = Error(o(519));
				function sl(e) {
					throw (hl(Er(Error(o(418, "")), e)), ul);
				}
				function cl(e) {
					var t = e.stateNode,
						n = e.type,
						r = e.memoizedProps;
					switch (((t[Oe] = e), (t[je] = r), n)) {
						case "dialog":
						...
						case "video":
						case "audio":
							for (n = 0; n < Dc.length; n++) Mc(Dc[n], t);
							break;
						case "source":
							Mc("error", t);
							break;
						...
						27 === n
							? ((n = ll),
							  mf(e.type)
									? ((e = bf), (bf = null), (ll = e))
									: (ll = n))
							: (ll = rl ? yf(e.stateNode.nextSibling) : null);
					return !0;
				}
				function pl() {
					(ll = rl = null), (al = !1);
				...
				function kl(e) {
					(e._currentValue = gl.current), U(gl);
				}
				function wl(e, t, n) {
					for (; null !== e; ) {
						var r = e.alternate;
				...
				var Nl =
					...
					Ll = r.unstable_scheduleCallback,
				...
				function Il() {
					if (0 === --Al && null !== Rl) {
						null !== Fl && (Fl.status = "fulfilled");
						var e = Rl;
						(Rl = null), (Ml = 0), (Fl = null);
				...
				function Vl() {
					...
					return null === e
						? null
						: { parent: Ol._currentValue, pool: e };
				}
				var ql = Error(o(460)),
					Wl = Error(o(474)),
					Ql = Error(o(542)),
				...
				function Ta(e, t, n, r, l, a) {
					return (
						...
						(t.lanes = 0),
						(D.H =
							null === e || null === e.memoizedState ? Wo : Qo),
						(Ea = !1),
						(a = n(r, l)),
						(Ea = !1),
						xa && (a = ja(t, n, r, l)),
				...
				function Oa(e) {
					...
					null === e ||
						Pi ||
						(null !== (e = e.dependencies) && El(e) && (Pi = !0));
				}
				function ja(e, t, n, r) {
					ba = e;
					var l = 0;
					do {
						if ((xa && (Pa = null), (za = 0), (xa = !1), 25 <= l))
							throw Error(o(301));
						if (
							((l += 1), (wa = ka = null), null != e.updateQueue)
						) {
							var a = e.updateQueue;
							(a.lastEffect = null),
								(a.events = null),
				...
				function Da() {
					var e = D.H,
						t = e.useState()[0];
					return (
						(t = "function" === typeof t.then ? Ua(t) : t),
						(e = e.useState()[0]),
						(null !== ka ? ka.memoizedState : null) !== e &&
							(ba.flags |= 1024),
						t
					);
				}
				...
				function Qa(e, t, n) {
					...
					var i = !Gn((ka || l).memoizedState, n);
					if (
						(i && ((l.memoizedState = n), (Pi = !0)),
						(l = l.queue),
						vo(2048, 8, Ya.bind(null, r, l, e), [e]),
						l.getSnapshot !== t ||
							i ||
				...
				function eo(e, t, n, r) {
					return (
						(e.baseState = n),
						qa(e, ka, "function" === typeof r ? r : Ba)
					);
				}
				...
				function po(e) {
					...
					Ia(), (t = t.memoizedState);
					var r = (n = Ia()).queue.dispatch;
				...
				function vo(e, t, n, r) {
					...
					null !== ka && null !== r && La(r, ka.memoizedState.deps)
						? (l.memoizedState = mo(t, a, n, r))
						: ((ba.flags |= e),
						  (l.memoizedState = mo(1 | t, a, n, r)));
				}
				function yo(e, t) {
					go(8390656, 8, e, t);
				}
				...
				function _o(e, t, n, r) {
					return Gn(n, t)
						? n
						: null !== pa.current
						? ((e = Po(e, n, r)), Gn(e, t) || (Pi = !0), e)
						: 0 === (42 & ya)
						? ((Pi = !0), (e.memoizedState = n))
						: ((e = Rs()), (ba.lanes |= e), (ps |= e), t);
				}
						...
						if (
							...
							try {
								...
								if (
									...
									return (
										Nr(e, t, l, 0), null === rs && _r(), !1
									);
							} catch (u) {}
						if (null !== (n = Lr(e, t, l, r)))
							return As(n, e, r), Vo(n, t, r), !0;
					}
					return !1;
				}
				function Ho(e, t, n, r) {
					...
					} else null !== (t = Lr(e, n, r, 2)) && As(t, e, 2);
				}
				function $o(e) {
					var t = e.alternate;
					...
					Wo = {
						...
						useReducer: function (e, t, n) {
							...
							return (
								...
								(r.queue = e),
								(e = e.dispatch = Fo.bind(null, ba, e)),
								[r.memoizedState, e]
							);
						},
						useRef: function (e) {
							return (
								(e = { current: e }), (Fa().memoizedState = e)
							);
						},
						useState: function (e) {
							var t = (e = Ja(e)).queue,
						...
						useCacheRefresh: function () {
							return (Fa().memoizedState = Mo.bind(null, ba));
						},
					},
					Qo = {
						readContext: zl,
						...
						useDebugValue: Eo,
						useDeferredValue: function (e, t) {
							return _o(Ia(), ka.memoizedState, e, t);
						},
						useTransition: function () {
							var e = Va(Ba)[0],
								t = Ia().memoizedState;
				...
				function Xo(e) {
					var t = Yo;
					return (Yo += 1), null === Go && (Go = []), Xl(Go, e, t);
				}
				function Zo(e, t) {
				...
				function ti(e) {
					...
					function l(e, t) {
						return (
							((e = Fr(e, t)).index = 0), (e.sibling = null), e
						);
					}
					function a(t, n, r) {
						return (
					...
					function d(e, t, n) {
						...
						if ("object" === typeof t && null !== t) {
							...
							if (j(t) || L(t))
								return (
									((t = Hr(t, e.mode, n, null)).return = e), t
								);
					...
					function v(e, t, n, r, l) {
						...
						if ("object" === typeof r && null !== r) {
							...
							if ("function" === typeof r.then)
								return v(e, t, n, Xo(r), l);
							if (r.$$typeof === w)
								return v(e, t, n, Pl(t, r), l);
							Jo(t, r);
						}
						return null;
					}
					function y(u, s, c, f) {
						if (
							...
							if ("function" === typeof c.then)
								return y(u, s, Xo(c), f);
							if (c.$$typeof === w) return y(u, s, Pl(u, c), f);
							Jo(u, c);
						}
					...
					return function (e, t, n, r) {
						try {
							...
							if (o === ql || o === Ql) throw o;
							var a = Ar(29, o, null, e.mode);
				...
				function Li(e, t, n, r, l) {
					if (null === e) {
						...
						return "function" !== typeof a ||
							...
							null !== n.compare
							? (((e = Ur(n.type, null, r, t, t.mode, l)).ref =
									t.ref),
							  (e.return = t),
							  (t.child = e))
				...
				function Ti(e, t, n, r, l) {
					if (null !== e) {
						...
						if (Yn(a, r) && e.ref === t.ref) {
							if (
								((Pi = !1), (t.pendingProps = r = a), !Yi(e, l))
							)
								return (t.lanes = e.lanes), Gi(e, t, l);
							0 !== (131072 & e.flags) && (Pi = !0);
						}
					}
					return Ri(e, t, n, r, l);
				}
					...
					if ("hidden" === r.mode) {
						...
						if (0 === (536870912 & n))
							return (
								...
								ji(e, t, null !== a ? a.baseLanes | n : n, n)
							);
						(t.memoizedState = { baseLanes: 0, cachePool: null }),
							null !== e &&
								Bl(0, null !== a ? a.cachePool : null),
							null !== a ? ha(t, a) : ga(),
							ii(t);
					} else
						null !== a
				...
				function ji(e, t, n, r) {
					...
					return (
						(l =
							null === l
								? null
								: { parent: Ol._currentValue, pool: l }),
				...
				function Mi(e, t, n, r, l) {
					if ((Cl(t), null === t.stateNode)) {
						var a = Dr,
							o = n.contextType;
						"object" === typeof o && null !== o && (a = zl(o)),
							(a = new n(r, a)),
							(t.memoizedState =
							...
							"function" === typeof n.getDerivedStateFromProps ||
								...
								o !== a.state &&
									pi.enqueueReplaceState(a, a.state, null),
								ca(t, r, a, l),
								sa(),
								(a.state = t.memoizedState)),
				...
				function Fi(e, t, n, r) {
					return pl(), (t.flags |= 256), _i(e, t, n, r), t.child;
				}
				var Ii = {
					dehydrated: null,
					treeContext: null,
				...
				function Ki(e, t, n) {
					var r = t.pendingProps,
						l = r.revealOrder,
						a = r.tail;
					if ((_i(e, t, r.children, n), 0 !== (2 & (r = ci.current))))
						(r = (1 & r) | 2), (t.flags |= 128);
					else {
						if (null !== e && 0 !== (128 & e.flags))
							e: for (e = t.child; null !== e; ) {
								if (13 === e.tag)
									null !== e.memoizedState && Wi(e, n, t);
				...
				function Gi(e, t, n) {
					if (
						...
						if (null === e) return null;
						if ((xl(e, t, n, !1), 0 === (n & t.childLanes)))
							return null;
					}
					if (null !== e && t.child !== e.child) throw Error(o(153));
					if (null !== t.child) {
						for (
							n = Fr((e = t.child), e.pendingProps),
								t.child = n,
								n.return = t;
							null !== e.sibling;
				...
				function Xi(e, t, n) {
					...
					switch (((t.lanes = 0), t.tag)) {
								...
								null === e
									? (n = Nf(
										...
										: al ||
										  ((n = t.type),
										  (e = t.pendingProps),
										  ((r = rf(V.current).createElement(n))[
												Oe
										  ] = t),
										  (r[je] = e),
										  ef(r, n, e),
						...
						case 27:
							return (
								...
								null === e &&
									al &&
									((r = t.stateNode =
										wf(t.type, t.pendingProps, V.current)),
									(rl = t),
									(il = !0),
									(l = ll),
									mf(t.type)
										? ((bf = l), (ll = yf(r.firstChild)))
										: (ll = l)),
						...
						case 12:
							return (
								_i(e, t, t.pendingProps.children, n), t.child
							);
						case 10:
							return (
								(r = t.pendingProps),
				...
				function ru(e, t, n) {
					...
					switch ((nl(t), t.tag)) {
						...
						case 19:
							if ((U(ci), null === (l = t.memoizedState)))
								return nu(t), null;
							if (
								((r = 0 !== (128 & t.flags)),
								null === (a = l.rendering))
				...
				function Nu(e, t, n) {
					...
					switch (n.tag) {
						...
						case 14:
						case 15:
							ku || iu(2, n, t), ku || iu(4, n, t), _u(e, t, n);
							break;
						case 1:
							ku ||
								(fu(n, t),
				...
				function Du(e, t) {
					...
					switch (e.tag) {
							...
							if (
								...
								if (((r = e.memoizedState), null === n))
									if (null === r)
										...
										e.stateNode = Rf(l, r, e.memoizedProps);
								else
									a !== r
										? (null === a
												? null !== n.stateNode &&
						...
						case 4:
							(r = ju),
								(ju = Cf(e.stateNode.containerInfo)),
								Ou(t, e),
								Ru(e),
								(ju = r);
							break;
					...
					for (
						...
						switch (a.tag) {
							...
							case 12:
								...
								break;
							case 13:
								Iu(l, a, n), n && 4 & o && Lu(l, a);
								break;
							case 22:
								null === a.memoizedState && Iu(l, a, n),
									cu(a, a.return);
								break;
							case 30:
								break;
				...
				function Hu(e, t) {
					(e = null),
						...
						(t = t.memoizedState.cache) !== e &&
							(t.refCount++, null != e && Dl(e));
				}
				function $u(e, t, n, r) {
					if (10256 & t.subtreeFlags)
						for (t = t.child; null !== t; )
							Bu(e, t, n, r), (t = t.sibling);
				}
				function Bu(e, t, n, r) {
					var l = t.flags;
					switch (t.tag) {
						...
						switch (o.tag) {
							...
							case 22:
								...
								null !== o.memoizedState
									...
									l && 2048 & s && Uu(o.alternate, o);
								break;
							case 24:
								Vu(a, o, i, u, l),
									l && 2048 & s && Hu(o.alternate, o);
								break;
							default:
								Vu(a, o, i, u, l);
						}
				...
				function qu(e, t) {
					if (10256 & t.subtreeFlags)
						for (t = t.child; null !== t; ) {
							...
							switch (r.tag) {
								case 22:
									qu(n, r), 2048 & l && Uu(r.alternate, r);
									break;
								case 24:
						...
						case 26:
							Qu(e),
								e.flags & Wu &&
									...
									})(ju, e.memoizedState, e.memoizedProps);
							break;
						case 5:
						default:
							Qu(e);
				...
				function Rs() {
					0 === gs &&
						(gs = 0 === (536870912 & as) || al ? Se() : 536870912);
					var e = li.current;
				...
				function Fs(e, t, n, r, l, a, i, u, s, c, f, d, p, m) {
					if (
						((e.timeoutHandle = -1),
						...
						t === ql || t === Ql
							...
							: (os =
									t === zi
										...
										: 1),
						(is = t),
						null === ls && ((ds = 1), wi(e, Er(t, e.current)));
				}
				function qs() {
					var e = D.H;
					return (D.H = qo), null === e ? qo : e;
				}
				function Ws() {
					var e = D.A;
					return (D.A = es), e;
				...
				function Zs(e) {
					...
					switch (t.tag) {
						case 15:
						case 0:
							t = Ai(n, t, t.pendingProps, t.type, void 0, as);
							break;
						case 11:
							t = Ai(
								n,
						...
						case 5:
							Ma(t);
						default:
							au(n, t), (t = Xi(n, (t = ls = Ir(t, fs)), fs));
					}
					(e.memoizedProps = e.pendingProps),
						null === t ? ec(e) : (ls = t);
				}
				function Js(e, t, n, r) {
					(yl = vl = null), Ma(t), (Go = null), (Yo = 0);
					var l = t.return;
					try {
						if (
							(function (e, t, n, r, l) {
						...
						return (
							(ds = 1), wi(e, Er(n, e.current)), void (ls = null)
						);
					}
					32768 & t.flags
						? (al || 1 === r
				...
				function sc(e, t, n) {
					(t = Er(n, t)),
						null !== (e = aa(e, (t = xi(e.stateNode, t, 2)), 2)) &&
							(Ce(e, 2), Sc(e));
				}
				function cc(e, t, n) {
					if (3 === e.tag) sc(e, e, n);
				...
				for (var Oc = 0; Oc < wr.length; Oc++) {
					...
					Sr(
						jc.toLowerCase(),
						"on" + (jc[0].toUpperCase() + jc.slice(1))
					);
				}
					...
					if (!e[Ic]) {
						(e[Ic] = !0),
							We.forEach(function (t) {
								"selectionchange" !== t &&
									(Rc.has(t) || Fc(t, !1, e), Fc(t, !0, e));
							});
						var t = 9 === e.nodeType ? e : e.ownerDocument;
						null === t ||
							t[Ic] ||
							((t[Ic] = !0), Fc("selectionchange", !1, t));
					}
				}
				function Hc(e, t, n, r) {
					switch (cd(t)) {
				...
				function ef(e, t, n) {
					switch (t) {
						...
						case "input":
							...
							return vt(e, r, u, s, c, i, a, !1), void ft(e);
						case "select":
						...
						case "video":
						case "audio":
							for (l = 0; l < Dc.length; l++) Mc(Dc[l], e);
							break;
						case "image":
							Mc("error", e), Mc("load", e);
							break;
						...
						if ((e.removeChild(n), a && 8 === a.nodeType))
							if ("/$" === (n = a.data)) {
								if (0 < r && 8 > r) {
									...
									if (
										(1 & n && Sf(o.documentElement),
										2 & n && Sf(o.body),
										4 & n)
									)
										for (
											Sf((n = o.head)), o = n.firstChild;
											o;
								...
								if (0 === l)
									return e.removeChild(a), void _d(t);
								l--;
							} else
								"$" === n || "$?" === n || "$!" === n
									? l++
				...
				R.d = {
					...
					D: function (e) {
						zf.D(e), _f("dns-prefetch", e, null);
					},
					C: function (e, t) {
						zf.C(e, t), _f("preconnect", e, t);
					},
					L: function (e, t, n) {
						zf.L(e, t, n);
						var r = Pf;
						...
						if (n && e) {
							...
							if (
								...
								switch (r) {
									...
									case "worker":
									case "script":
										if (n.querySelector(Df(a))) return;
								}
				...
				function Uf(e, t, n) {
					if (null === If) {
						...
						(r = (l = If).get(n)) || ((r = new Map()), l.set(n, r));
					if (r.has(e)) return r;
					for (
				...
				function nd(e) {
					if (13 === e.tag) {
						var t = Tr(e, 67108864);
						null !== t && As(t, 0, 67108864), td(e, 67108864);
					}
				}
				var rd = !0;
				function ld(e, t, n, r) {
				...
				function _d(e) {
					...
					for (; 0 < vd.length && null === (n = vd[0]).blockedOn; )
						wd(n), null === n.blockedOn && vd.shift();
				...
				(Ld.prototype.render = Nd.prototype.render =
					function (e) {
						var t = this._internalRoot;
						if (null === t) throw Error(o(409));
						Jf(t.current, Ds(), e, t, null, null);
					}),
					(Ld.prototype.unmount = Nd.prototype.unmount =
						function () {
							var e = this._internalRoot;
							if (null !== e) {
								this._internalRoot = null;
								var t = e.containerInfo;
								Jf(e.current, 2, null, e, null, null),
									Hs(),
									(t[De] = null);
							}
						}),
					(Ld.prototype.unstable_scheduleHydration = function (e) {
						if (e) {
							...
							for (
								var n = 0;
								n < vd.length && 0 !== t && t < vd[n].priority;
								n++
							);
							vd.splice(n, 0, e), 0 === n && wd(e);
						}
					});
				var Td = l.version;
				if ("19.1.1" !== Td) throw Error(o(527, Td, "19.1.1"));
	...
	(n.m = e),
		...
		(() => {
			...
			var t = (t, r) => {
				...
				r = (self.webpackChunkslider_logic =
					self.webpackChunkslider_logic || []);
	...
	const c = Object.freeze({ SHORT: Symbol("short"), LONG: Symbol("long") });
	var f = n(579);
	const d = (e, t, n, r, l) => {
		var a;
		let o = null,
		...
		if (
			null !==
				(a = Object.keys(
					null === e || void 0 === e ? void 0 : e.names
				)) &&
			void 0 !== a &&
			a.includes(n)
		) {
			let r = null === e || void 0 === e ? void 0 : e.names[n],
				l = null === r || void 0 === r ? void 0 : r.labels;
			var u;
			if (null !== l && void 0 !== l && l.long && t === c.LONG)
				o =
					null === r ||
					void 0 === r ||
					null === (u = r.labels) ||
					void 0 === u
						? void 0
						: u.long;
			else if (null !== l && void 0 !== l && l.short && t === c.SHORT) {
				var s;
				o =
					null === r ||
					void 0 === r ||
		...
		if (o)
			return (0, f.jsx)(
				"p",
				{ className: "".concat(r), style: { color: i }, children: o },
				"".concat(l, "-").concat(n)
			);
	};
	const p = (e, t, n) => {
			...
			let l = [],
				...
				o =
					...
					void 0 === r
						? void 0
						: r.requirements) || {};
			for (let i of Object.keys(o)) i === n && (l = o[i]);
			for (let i of l) t[i] <= 0 && a.push("".concat(i));
			return a;
		},
		m = (0, f.jsx)("svg", {
	...
	const P = (e) => {
		let {
				...
				displayLock: l,
				displayLabels: a,
				blockingConditions: o,
			} = e,
			i = r ? "opacity-100 z-[2]" : "opacity-0 z-[0]";
		return (
			(i = l ? i : "opacity-0 z-[0]"),
			(0, f.jsxs)("div", {
				className: "absolute bottom-[55%] overflow-visible ".concat(
					i,
					" transition-opacity duration-300 pointer-events-none"
				),
				children: [
					(0, f.jsx)("p", { className: "scale-[5]", children: b }),
					(0, f.jsx)("ul", {
						className: "".concat(
							i,
							" transition-opacity duration-300 absolute top-[50%] left-[50%] -translate-x-1/2 flex items-center justify-center flex-col"
						),
						children: o.map((e) => {
							let r = d(
								t,
								...
								"slider-blocker-of-".concat(n)
							);
							return (0, f.jsx)(
								"li",
								{ children: r },
								"li-slider-blocker-of-".concat(n, "-").concat(e)
							);
						}),
					}),
				],
	...
	const _ = (e) => {
		...
		let {
			...
			c = null === a || void 0 === a ? void 0 : a.rules;
		if (
			!c ||
			0 ===
				(null === (t = Object.keys(c)) || void 0 === t
					? void 0
					: t.length)
		)
			return;
		let p = (e, t) => {
				for (let n of t) {
					let t = d(a, s, n, null, "slider-info-of-".concat(o));
					e.push(t);
				}
			},
			m = [],
		...
		if (
			null !==
				(n = Object.keys(
					null === c || void 0 === c ? void 0 : c.requirements
				)) &&
			void 0 !== n &&
			n.includes(o)
		) {
			p(m, null === c || void 0 === c ? void 0 : c.requirements[o]);
		}
		let v =
			(null === c ||
			void 0 === c ||
			...
			void 0 === r
				? void 0
				: r.filter((e) =>
						null === e || void 0 === e ? void 0 : e.includes(o)
				  )) || [];
		if (v.length > 0) {
			let e = [];
			for (let t of v)
				e.push(
					null === t || void 0 === t ? void 0 : t.find((e) => e !== o)
				);
			p(h, e);
		}
		let y =
		...
		if (0 === [...m, ...h, ...g].length) return;
		let k = u ? "opacity-100 z-[2]" : "opacity-0 z-[0]";
		return (0, f.jsxs)("ul", {
			className:
				"bg-white/50 backdrop-blur-sm rounded-lg p-2 text-center mt-12 absolute top-0 select-none cursor-default ".concat(
					k,
					" transition-opacity duration-1000 flex flex-col items-start justify-center pointer-events-none"
				),
			children: [
	...
	const N = (e) => {
		...
		let {
			...
			c =
				...
				void 0 === n
					? void 0
					: n.color) || "rbga(255, 255, 255, 1)",
			m = l[r],
			h = m,
			g = 0;
		m <= 10 ? (g = 5) : m >= 80 && (g = -5), (h += g);
		let v = !1,
			y = p(a, l, r);
		v = y.length > 0;
		let b = v ? "opacity-25" : "opacity-100",
			k =
				"text-3xl text-center mt-12 absolute bottom-0 translate-y-full select-none cursor-default ".concat(
					" transition-opacity duration-1000"
				),
			w = d(a, i, r, k, "global-slider-label-of");
		return (0, f.jsxs)("div", {
			className:
				"slider-container z-[1] flex flex-col h-[70vh] items-center justify-center relative",
			children: [
				(0, f.jsx)("input", {
					className:
						"w-[70vh] -rotate-90 absolute bottom-[50%] ".concat(
							b,
							" transition-opacity duration-1000"
						),
					type: "range",
	...
	const T = (e) => {
		let t = {},
			n =
				null !== e && void 0 !== e && e.names
					? Object.keys(null === e || void 0 === e ? void 0 : e.names)
					: [];
		for (let r of n) t[r] = 0;
		return t;
	};
	const O = async (e, t, n, r) => {
		let l = s({}, e);
		try {
			n(T(t)), r(t);
		} catch (a) {
	...
	const D = (e) => {
			...
			_ = {
				...
				settings: {
					...
					onClick: async (e) => {
						let t = "";
						if (L())
							t = prompt("Please Enter a new Settings-Object!");
						else {
		...
		return (0, f.jsxs)("header", {
			className: "absolute top-0 left-0 z-[2] h-fit ".concat(
				z ? "" : "-translate-x-[100%]",
			...
			children: [
				Object.keys(_).map((e) => {
					let t = _[e],
						n = t.logicState ? "opacity-100" : "opacity-25",
						r = t.iconInactive;
					return (
						t.logicState === c.LONG && (r = t.iconActive),
						(0, f.jsx)(
							"button",
							{
								className: ""
									.concat(n, " ")
									.concat(
										"bg-gray-500/50 hover:bg-gray-700/50 active:scale-[0.9] text-white flex items-center justify-center p-1",
										" rounded-md"
									),
								onClick: t.onClick,
								children: r,
							},
							"header-button-".concat(e)
						)
					);
				}),
				(0, f.jsx)("button", {
					className:
						"absolute top-[50%] right-[0] -translate-y-1/2 translate-x-[100%] rounded-r-lg !m-0 bg-gray-600/30 shadow-md p-1 opacity-25 hover:opacity-100 transition-all",
					onClick: () => {
						P(!z);
					},
					children: (0, f.jsx)("p", {
						className: "transition-all ".concat(N),
						children: m,
					}),
				}),
			],
	...
	const A = () => {
			let [e, t] = (0, r.useState)(T(R)),
				[n, l] = (0, r.useState)(R),
				[a, o] = (0, r.useState)(c.SHORT),
				[i, u] = (0, r.useState)(!0),
				[d, m] = (0, r.useState)(!1),
				[h, g] = (0, r.useState)(!1);
			(0, r.useEffect)(() => {
				try {
					let e = new URL(document.location.toString()).searchParams,
						r =
							null === e || void 0 === e
								? void 0
								: e.get("settings"),
						a = JSON.parse(decodeURIComponent(r));
					if (!a) return;
					let o = Object.keys(a) || [];
					if (!o.includes("names") && o.includes("rules")) return;
					O(n, a, t, l);
				} catch (e) {}
			}, []);
			let v = (r, l) => {
				let a = s({}, e);
				a[r] = l;
				let o = null === n || void 0 === n ? void 0 : n.rules,
					i =
						(null === o || void 0 === o
							? void 0
							: o.requirements) || {},
					u =
						(null === o || void 0 === o ? void 0 : o.exclusions) ||
						[],
					c =
						(null === o || void 0 === o
							? void 0
					...
					d = (e) => {
						for (let t of u)
							if (null !== t && void 0 !== t && t.includes(e)) {
								let n =
									null === t || void 0 === t
										? void 0
										: t.find((t) => t !== e);
					...
					m = (t, r, l) => {
						for (let o of l)
							if (null !== o && void 0 !== o && o.includes(t)) {
								let u =
									null === o || void 0 === o
										? void 0
										: o.find((e) => e !== t);
								0 === p(n, e, u).length && (a[u] = r),
									0 === r &&
										Object.keys(i).length > 0 &&
										f(u),
									d(u);
								let s = [...l];
								s.splice(l.indexOf(o), 1), m(u, r, s);
							}
					};
				0 === l && Object.keys(i).length > 0 && f(r),
					l > 0 && u.length > 0 && d(r),
					c.length > 0 && m(r, l, c),
					t(a);
			};
			return (0, f.jsxs)("div", {
				className:
					"min-w-screen min-h-screen bg-gray-800 text-white flex justify-center items-center",
				children: [
					(0, f.jsx)(D, {
						labelDisplay: a,
						setLabelDisplay: o,
						...
						resetSliderValues: () => {
							let n = s({}, e);
							for (let e of Object.keys(n)) n[e] = 0;
							t(n);
						},
					}),
					(0, f.jsx)("div", {
						className:
							"w-[90%] px-4 py-8 justify-around flex flex-row",
					...
					(0, f.jsxs)("div", {
						className:
							"absolute top-0 right-0 p-2 italic flex items-center justify-center space-x-2 animate-opacity duration-300 ".concat(
								h ? "opacity-50" : "opacity-0"
							),
						children: [
							(0, f.jsx)("p", {
								children:
									"This app is for my private (personal) use only and does not represent a public product or service.",
							}),
							(0, f.jsxs)("a", {
								...
								className:
									"flex items-center justify-center space-x-1 hover:underline",
								children: [
									(0, f.jsx)("p", { children: z }),
									(0, f.jsx)("p", { children: "GitHub" }),
								],
							}),
						],
					}),
	...
	l
		...
		.render((0, f.jsx)(r.StrictMode, { children: (0, f.jsx)(A, {}) })),
		M();
})();
//# sourceMappingURL=main.5b7009b1.js.map
